...
import { Eye, EyeOff, AlertCircle, Loader2, Shield, Lock, Database } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[300px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(ellipse, #f472b6 0%, transparent 70%)', filter: 'blur(80px)', opacity: 0.06 }} />
          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-2.5 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs">Protected by Supabase Authentication</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 mt-5 pt-5 border-t border-white/5">
              {[
                ...
                { icon: Database, label: 'Supabase Auth'  },
              ].map(({ icon: Icon, label }) => (
